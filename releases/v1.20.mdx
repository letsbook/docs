...
- Add-on products can now be priced per boat, per passenger, or per hour or per day per boat, not just as a flat unit price. Configure it in your [add-on settings](/guides/settings/create-add-ons/).
