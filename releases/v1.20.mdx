...
- **Sentinel Marine** joins our [hardware integrations](https://dashboard.letsbook.app/integrations/hardware) with OAuth connect and engine lock/unlock on trip start and end. Sentinel replaces Trackunit, which is being phased out.
