...
- Add-on products can now be priced per boat, per passenger, per hour-per-boat, or per day-per-boat, not just as a flat unit price. Configure it in your [add-on settings](/guides/boost-revenue/sell-add-ons-and-extras).
