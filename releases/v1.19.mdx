...
Operating in multiple languages? Set a unique terms & conditions URL and custom return URL for each activated language. The booking form picks the right one based on the customer's language.
