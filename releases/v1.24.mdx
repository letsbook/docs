...
- **Phone numbers are asked by default.** New booking forms now require a phone number, because almost everyone wants one for last-minute changes. Never set this yourself? Check your [phone number setting](https://dashboard.letsbook.app/booking-form/phone-number-requirement) if you'd rather keep it optional.
