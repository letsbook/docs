...
Hero image for this highlight: a card reader in action or the terminal step in the Collect payment modal, saved as `./images/v1.24_terminals.png` (max ~360px wide).
