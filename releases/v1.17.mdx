...
richTextSummary: '<p>Your planning overview just got a massive glow-up!</p><ul><li>Availability bars now live right in the timeline, so you see capacity and bookings side by side</li><li>Margins and block bookings are visible at a glance, no more scheduling surprises</li><li>Filter by dock and boat type, then save your favorite views</li><li>Coupon code management is overhauled with search, archiving, and editable limits</li></ul>'
