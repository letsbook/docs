...
richTextSummary: '<p>Your booking form and emails just leveled up!</p><ul><li>Add checkboxes, radio buttons, and dropdowns to your booking questions</li><li>Fully customize every system email with personal customer variables</li><li>Book on behalf of a partner and apply their pricing automatically</li><li>Send 24-hour trip reminders and hide $0 charges from the payment overview</li></ul>'
...
<Button href="https://dashboard.letsbook.app/bookings/add">Add booking</Button>
