...
richTextSummary: '<p>Less typing, more renting in this release!</p><ul><li>Save recurring costs and discounts as one-click presets, now with percentage support</li><li>Booking notes and cash payments show up on the activity timeline</li><li>Cleaner waiver prefill, plus security improvements</li></ul>'
...
- **Your booking timeline tracks more.** Booking notes and cash payments now appear on the [activity timeline](/guides/day-to-day/tracking-changes), added, edited, or removed, with who did it and when.
