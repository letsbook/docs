...
richTextSummary: '<p>Less typing, more renting in this release!</p><ul><li>Save recurring costs and discounts as one-click presets, now with percentage support</li><li>Booking notes show up on the activity timeline</li><li>Cleaner waiver prefill, plus security improvements</li></ul>'
...
- **Booking notes now show on the timeline.** Every note you add, edit, or remove appears on the booking's [activity timeline](/guides/day-to-day/tracking-changes), with who did it and when.
