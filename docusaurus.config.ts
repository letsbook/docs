    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/letsbook/public-docs/tree/main/',
        },
        blog: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/letsbook/public-docs',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} LetsBook. Built with Docusaurus.`,
    },
    prism: {
