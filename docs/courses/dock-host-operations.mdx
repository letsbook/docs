...
<YoutubeVideoPlayer videoId="VIDEO_ID_HERE" title="Multi-location operations" />
...
- **[Manage boats](/guides/settings/boats/manage-boats)** - Boat configuration and organization
- **[Understanding rental setups](/guides/settings/rental-setups)** - Location-based configurations
