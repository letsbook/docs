...
<YoutubeVideoPlayer videoId="VIDEO_ID_HERE" title="Getting started guide" />
...
- **[Add boats](/guides/settings/boats/manage-boats/)** - Complete boat configuration
- **[Set up pricing](/guides/settings/rental-setups/pricing/)** - All pricing options explained
- **[Configure schedules](/guides/settings/rental-setups/schedules/)** - Operating hours and seasons
- **[Connect payments](/guides/settings/payments/receive-payments/)** - Stripe and Mollie setup
- **[Customize booking form](/guides/settings/booking-form/match-branding/)** - Match your branding
