...
**Flag pennants** - [Flagged bookings](/guides/day-to-day/bookings/flag-bookings) show a red pennant right on the booking bar, so the ones that need attention stand out.
