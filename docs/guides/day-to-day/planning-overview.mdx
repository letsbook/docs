---
description: See boat availability, buffer time, and bookings in one unified view
sidebar_position: 3
...
Your planning overview shows everything you need to run daily operations: boat availability, buffer time, blocks, and all your trips in one timeline view.
...
**Buffer time** - The extra time you block before and after trips appears directly in the timeline. Spot exactly when late returns will cause problems.
...
**Flags** - [Flagged bookings](/guides/day-to-day/bookings/flag-bookings) show a red flag right on the booking bar, so the ones that need attention stand out.
