...
<InlineVideoPlayer
    videoSrc={require('./graphics/start_trip_method1.mp4').default}
...
<InlineVideoPlayer
    videoSrc={require('./graphics/start_trip_method2.mp4').default}
...
<InlineVideoPlayer
    videoSrc={require('./graphics/switch_boat.mp4').default}
...
<InlineVideoPlayer
    videoSrc={require('./graphics/stop_trip.mp4').default}
