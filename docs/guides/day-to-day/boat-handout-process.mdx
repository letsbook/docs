...
import startTripMethod1Video from './graphics/start_trip_method1.mp4';
import startTripMethod2Video from './graphics/start_trip_method2.mp4';
import stopTripVideo from './graphics/stop_trip.mp4';
import switchBoatVideo from './graphics/switch_boat.mp4';
...
### Method 1: Fleet view (primary)

1. Go to [Fleet view](https://dashboard.letsbook.app/fleet)
...
🔴 **VERVANG:**
<InlineVideoPlayer
    videoSrc={startTripMethod1Video}
    title="Assign from fleet overview"
/>
...
🔴 **VERVANG:**
<InlineVideoPlayer
    videoSrc={startTripMethod2Video}
    title="Assign from booking details"
/>
...
🔴 **VERVANG:**
<InlineVideoPlayer videoSrc={switchBoatVideo} title="Switch boat during trip" />

### From fleet view

- **Stop button:** End any active trip directly from the [Fleet view](https://dashboard.letsbook.app/fleet)
...
🔴 **VERVANG:**
<InlineVideoPlayer
    videoSrc={stopTripVideo}
    title="Stop trip from fleet overview"
/>
