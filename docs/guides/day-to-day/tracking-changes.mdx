...
import bookingTimelineVideo from './graphics/booking_timeline.mp4';
...
<InlineVideoPlayer videoSrc={bookingTimelineVideo} />
...
- **Booking note added, updated, or removed**: When someone adds, edits, or removes a note on the booking.
- **Cash payment added, updated, or removed**: When someone adds, edits, or removes a cash payment on the booking.
- **Add-on added, changed, or removed**: When someone adds, changes, or removes an add-on on the booking, with the before and after.
