...
import addBlockVideo from './graphics/add_block.mp4';
...
<InlineVideoPlayer videoSrc={addBlockVideo} />
...
Blockouts appear directly in your planning timeline. Go to [planning overview](https://dashboard.letsbook.app/planning) to see blocked periods shown in the timeline. They're clearly visible so you never accidentally schedule over them. Click any availability bar to open the [availability view](/guides/day-to-day/planning-overview#availability-view) and see exactly how many boats are still available during active blocks.
