...
If you've enabled card charging in [integrations](https://dashboard.letsbook.app/integrations), you'll see a **Charge card** button here to directly charge saved payment methods.
...
The new costs appear immediately and update the balance. Standard booking costs (the rental itself) can't be edited here.
...
Register payments made outside the system (cash, bank transfer).
...
Standard rental costs adjust automatically, but you might need to add or remove costs manually.
