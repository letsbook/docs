...
If you've enabled **Keep card on file** in [integrations](https://dashboard.letsbook.app/integrations/psp), you'll see a **Charge card** button here to directly charge saved payment methods.
...
:::danger[🎥 TODO]
Re-record this discount flow video to show the Quick presets picker and Percentage mode.
:::
...
:::danger[🎥 TODO]
Re-record this add-costs flow video to show the Quick presets picker and Percentage mode.
:::
