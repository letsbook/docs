...
import cancellationFeeVideo from '../graphics/wrap-up-cancellation_fee.mp4';
import returnDepositVideo from '../graphics/wrap-up-return_deposit.mov';
...
![The next-step card on the Finance tab, ready to return the deposit](../graphics/wrap-up-next-step.png)
...
<InlineVideoPlayer videoSrc={returnDepositVideo} />
...
<InlineVideoPlayer videoSrc={cancellationFeeVideo} />
