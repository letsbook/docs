...
**Limit consumables per person per hour:** Perfect for drinks. Set "2 beers per person per hour" and the total automatically scales to group size and trip length. Prevents over/under ordering.
