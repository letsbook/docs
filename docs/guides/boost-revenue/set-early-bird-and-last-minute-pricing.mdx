...
import earlyBirdVideo from './graphics/early_bird.mp4';
...
<InlineVideoPlayer videoSrc={earlyBirdVideo} />
...
Rather block last-minute chaos entirely? Set minimum advance booking requirements in your [booking and cancellation rules](/guides/settings/customers/booking-cancellation-rules#control-advance-booking-time).
...
Access advanced mode when setting up the charge formula. See [pricing formulas](/guides/settings/dive-deeper/pricing-formulas) for formula syntax.
