...
import LocalFileVideoPlayer from "../../../src/components/LocalFileVideoPlayer";
...
<LocalFileVideoPlayer videoSrc={require('./graphics/review.mp4').default}/>
...
<LocalFileVideoPlayer videoSrc={require('./graphics/google_review.mov').default}/>
