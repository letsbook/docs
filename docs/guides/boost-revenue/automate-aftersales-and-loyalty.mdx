...
import googleReviewVideo from './graphics/google_review.mov';
import reviewVideo from './graphics/review.mp4';
...
<InlineVideoPlayer videoSrc={reviewVideo} />
...
<InlineVideoPlayer videoSrc={googleReviewVideo} />
