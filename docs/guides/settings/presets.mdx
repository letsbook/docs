...
import createCostPresetVideo from './graphics/add_costs_presets.mp4';
import createDiscountPresetVideo from './graphics/add_discount_presets.mp4';
import applyPresetVideo from './graphics/apply_discounts_costss.mp4';

# Cost and discount presets

[Manage presets](https://dashboard.letsbook.app/presets/costs)
...
- **[Cost presets](https://dashboard.letsbook.app/presets/costs)** for recurring extra charges (cleaning, fuel, late-return fee, damage)
- **[Discount presets](https://dashboard.letsbook.app/presets/discounts)** for recurring discounts (loyalty, birthday, partner rate)

## Create a cost preset

1. Go to [**Cost presets**](https://dashboard.letsbook.app/presets/costs)
2. Click **Add preset**
...
<InlineVideoPlayer videoSrc={createCostPresetVideo} />

## Create a discount preset

1. Go to [**Discount presets**](https://dashboard.letsbook.app/presets/discounts)
2. Click **Add preset**
...
<InlineVideoPlayer videoSrc={createDiscountPresetVideo} />
...
<InlineVideoPlayer videoSrc={applyPresetVideo} />
