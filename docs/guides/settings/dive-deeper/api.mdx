...
Create API keys from the [integrations](https://dashboard.letsbook.app/integrations/api) page. Copy it once and stash it somewhere safe. We only show it at creation.
