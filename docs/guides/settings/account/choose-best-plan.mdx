...
<div className={styles.planCard}>
    ...
    <div className={styles.planBody}>
        <p className={styles.planDescription}>
            Perfect for small and medium-sized rental businesses getting started
            or with seasonal operations.
        </p>
        ...
        <div className={styles.planSection}>
            ...
            <p>
                Low fixed cost with reasonable booking fees means you only pay
                more when you're making more. Perfect for testing the waters or
    ...
    <div className={styles.planFooter}>
        <a
            href="https://lets-book.com/en/get-started"
...
<div className={styles.planCard}>
    ...
    <div className={styles.planBody}>
        <p className={styles.planDescription}>
            The smart choice for growing rental businesses with higher volume
            and annual turnover of $100,000+.
        </p>
        ...
        <div className={styles.planSection}>
            <strong>Why it works:</strong>
            <p>
                Higher fixed cost pays for itself quickly with the lower 1%
                booking fee. More predictable costs as you scale, with
                significant savings on every booking.
            </p>
        </div>
    </div>
