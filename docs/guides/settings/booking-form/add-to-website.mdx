...
Add the following snippet to the `<head>` section of your website. You can also find it in the [integration instructions](https://dashboard.letsbook.app/booking-form/integration-instructions).
...
Using WordPress, Wix, or Squarespace? Follow the steps for your platform:

<Tabs queryString="platform">
    <TabItem label="WordPress" value="wordpress" default>
        Our WordPress plugin handles the script for you, so you can skip the snippet above.
