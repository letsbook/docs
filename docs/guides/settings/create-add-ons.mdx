...
- **Per hour per boat** - Multiplies by hours × boats. Toggle "Round up to nearest hour" for whole-hour billing.
- **Per day per boat** - Same idea but in days. Toggle "Round up to nearest day" for whole-day billing.
