...
<Button href="https://dashboard.letsbook.app/add-ons/add">Create add-ons</Button>
...
<Button href="https://dashboard.letsbook.app/add-ons/categories">Manage categories</Button>
