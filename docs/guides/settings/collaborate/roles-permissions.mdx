...
import rolesAddingRoleVideo from '../graphics/roles_adding_role.mp4';
...
1. Go to [users](https://dashboard.letsbook.app/users) and click [roles & permissions](https://dashboard.letsbook.app/users/roles)
...
1. Go to [edit hierarchy](https://dashboard.letsbook.app/users/roles/hierarchy)
2. Drag the roles into the desired order

<InlineVideoPlayer videoSrc={rolesAddingRoleVideo} />
