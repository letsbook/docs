...
<LocalFileVideoPlayer videoSrc={require('../graphics/roles_send_invite.mp4').default}/>
...
<LocalFileVideoPlayer videoSrc={require('../graphics/roles_send_reminder.mp4').default}/>
