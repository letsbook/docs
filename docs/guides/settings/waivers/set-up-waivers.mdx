...
import waiverConnectVideo from '../graphics/waiver_connect.mp4';
import waiverPrefillVideo from '../graphics/waiver_prefill.mp4';
...
<InlineVideoPlayer videoSrc={waiverPrefillVideo} />
...
<InlineVideoPlayer videoSrc={waiverConnectVideo} />
