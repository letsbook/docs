...
import rentalSetupVideo from '../graphics/rental_setup.mp4';
...
<InlineVideoPlayer videoSrc={rentalSetupVideo} />
...
### Archiving time periods

Time periods you no longer need (past or future) can be archived from the rental setup overview, keeping the list clean without losing history.
