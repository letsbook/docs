...
Automatically sent when booking details change (time, date, boat, etc.). Prefer these not to go out at all? Turn them off for your whole account in your [general settings](https://dashboard.letsbook.app/general-info).
