...
Automatically sent when booking details change (time, date, boat, etc.). Prefer these not to go out at all? Turn them off for your whole account on the [notifications page](https://dashboard.letsbook.app/notifications).
