...
<InlineVideoPlayer
    videoSrc={require('../../graphics/settings_pricing_slots.mp4').default}
/>
...
<InlineVideoPlayer
    videoSrc={require('../../graphics/pricing_additional_charge.mp4').default}
/>
...
<InlineVideoPlayer
    videoSrc={require('../../graphics/pricing_deposit.mp4').default}
/>
