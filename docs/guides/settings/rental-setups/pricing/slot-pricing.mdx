...
<LocalFileVideoPlayer videoSrc={require('../../graphics/settings_pricing_slots.mp4').default}/>
...
<LocalFileVideoPlayer videoSrc={require('../../graphics/pricing_additional_charge.mp4').default}/>
