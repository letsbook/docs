...
import pricingFlexiblePricingVideo from '../../graphics/pricing_flexible_pricing.mov';
...
<Button href="https://dashboard.letsbook.app/pricing/flexible/add">
...
<InlineVideoPlayer videoSrc={pricingFlexiblePricingVideo} />
...
**Advanced mode:** Use complex formulas with multiple variables and calculations. See [Working with pricing formulas](/guides/settings/dive-deeper/pricing-formulas) for detailed formula syntax.
