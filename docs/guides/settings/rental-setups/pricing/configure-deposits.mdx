...
import addDepositVideo from '../../graphics/pricing_add_deposit.mp4';
...
<InlineVideoPlayer videoSrc={addDepositVideo} />
...
3. Click **Return security deposit**, in full or partly if you're withholding costs
4. Click **Return now**, and the money returns through the original payment method

See [return deposits and refunds](/guides/day-to-day/bookings/return-deposits-and-refunds) for the full flow, or settle a whole day of finished bookings at once on the [Booking wrap-up page](/guides/day-to-day/bookings/booking-wrap-up).
