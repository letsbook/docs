...
<LocalFileVideoPlayer videoSrc={require('../../graphics/pricing_simple_pricing_groups.mp4').default}/>
...
<LocalFileVideoPlayer videoSrc={require('../../graphics/pricing_simple_pricing_additional_charges.mp4').default}/>
...
<LocalFileVideoPlayer videoSrc={require('../../graphics/pricing_deposit.mp4').default}/>
