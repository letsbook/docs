...
<Button href="https://dashboard.letsbook.app/pricing/simple/add">
...
<InlineVideoPlayer videoSrc={pricingSimplePricingGroupsVideo} />
...
<InlineVideoPlayer videoSrc={pricingSimplePricingAdditionalChargesVideo} />
