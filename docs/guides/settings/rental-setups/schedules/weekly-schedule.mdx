...
<Button href="https://dashboard.letsbook.app/schedules/week/add">
...
**Example:** 30 minutes of buffer time gives you cleanup time between rentals and handles boats returned slightly late.
