...
<InlineVideoPlayer
    videoSrc={require('../../graphics/Schedules_fixed_lenghts.mp4').default}
...
<InlineVideoPlayer
    videoSrc={require('../../graphics/schedules_within_range.mp4').default}
...
<InlineVideoPlayer
    videoSrc={require('../../graphics/schedule_advanced_settings.mp4').default}
