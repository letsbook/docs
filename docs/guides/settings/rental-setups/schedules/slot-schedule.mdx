...
The schedule sets the default. Need more turnaround for one specific booking? Edit the margins directly on that booking in the dashboard booking form, without touching your schedule.
