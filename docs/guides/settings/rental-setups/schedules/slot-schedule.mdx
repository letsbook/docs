...
<LocalFileVideoPlayer videoSrc={require('../../graphics/schedules_slots_add.mp4').default}/>
...
<LocalFileVideoPlayer videoSrc={require('../../graphics/schedules_slots_multiday.mp4').default}/>
