...
<Button href="https://dashboard.letsbook.app/schedules/slot/add">Create new slot schedule</Button>
...
<InlineVideoPlayer
    videoSrc={scheduleSlotsAddVideo}
/>
...
<InlineVideoPlayer
    videoSrc={scheduleSlotsMultidayVideo}
/>
