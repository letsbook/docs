...
import scheduleSlotsAddVideo from '../../graphics/schedules_slots_add.mp4';
import scheduleSlotsMultidayVideo from '../../graphics/schedules_slots_multiday.mp4';
...
<Button href="https://dashboard.letsbook.app/schedules/slot/add">
...
<InlineVideoPlayer videoSrc={scheduleSlotsAddVideo} />
...
<InlineVideoPlayer videoSrc={scheduleSlotsMultidayVideo} />
...
Block extra time around a slot for cleaning, prep, or a late return. Set it per slot, before the slot, after it, or both, so a quick sundowner and a full-day charter each get the turnaround they need.

**Example:** 30 minutes after your afternoon slot covers cleanup before the next trip. A multi-day charter might need a couple of hours.

The schedule sets the default. Need more turnaround for one specific booking? On the Margins card of that booking in the dashboard booking form, flip Override and pick the time before pickup and after return, without touching your schedule.
