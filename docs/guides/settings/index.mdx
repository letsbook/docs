...
Configure pricing, schedules, integrations, and all the core settings that power your rental operation. New to Let's Book? The [onboarding dashboard](https://dashboard.letsbook.app/?showOnboardingDashboard=1) walks you through every step and tracks your progress as you go.
...
- **[Cost and discount presets](./presets)** - Save recurring costs and discounts and apply them in one click
...
- **[Booking cancellation rules](./customers/booking-cancellation-rules)** - Configure refund policies and cancellation windows
